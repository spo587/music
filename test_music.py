...
def somewhere():
    ...
    offset_bass = msw.Tone('rest',2.0,crappy_instrument)

    offset = msw.Tone('rest',2.0,crappy_instrument)
...
def somewhere2():
    ...
    line2 = msw.Line([[('bb',-1),2.0],[('bb',0),2.0],[('f',-1),3.0],[('g',-1),1.0],[('eb',-1),4.0],[('eb',-1),4.0],
                    [('c',-1),3.0],[('d',-1),0.5],[('c',-1),0.5],[('b',-1),2.0],[('c',-1),2.0],[('rest'),1.5],[('eb',-1),1.5],
                    [('d',-1),1.0],[('eb',-1),4.0]],crappy_instrument)
    line3 = msw.Line([[('g',-2),2.0],[('g',-1),2.0],[('rest'),4.0],[('c',-1),1.0],[('ab',-1),0.5],[('bb',-1),0.5],
                    [('c',-1),1.0],[('d',-1),1.0],[('eb',-1),4.0],[('rest'),6.0],[('bb',-1),2.0],[('c',-1),3.0],
                    [('bb',-1),1.0],[('g',-2),4.0]],crappy_instrument)

    line4 = msw.Line([[('rest'),4.0],[('bb',-2),2.0],[('bb',-1),2.0],[('rest'),1.0],[('ab',-1),3.0],
